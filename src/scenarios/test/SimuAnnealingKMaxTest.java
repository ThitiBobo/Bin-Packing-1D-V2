...
public class SimuAnnealingKMaxTest extends ScriptBase {
    ...
    public static void main(String[] args) {
        ScriptBase script = new SimuAnnealingKMaxTest();
        script.start();
    }

    public SimuAnnealingKMaxTest(){
        super();
    ...
    protected void display() {
        ...
        System.out.println("K_MAX : " + this.k_max);
